...
class Common {
    ...
    static var entityMap:DynamicAccess<String>;
    static var legacyMap:DynamicAccess<String>;
    static var decodeMap:DynamicAccess<Int>;
